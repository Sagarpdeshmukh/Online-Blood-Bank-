...
public class BloodStockController {
	...
	public ResponseEntity<BloodStock> getBloodStockById(@PathVariable String bloodgrp) {
		BloodStock bl = bloodStockRepository.findById(bloodgrp)
				.orElseThrow(() -> new ResourceNotFoundException("User Not Exist with Id=" + bloodgrp));
	...
	public ResponseEntity<BloodStock> updateBloodStock(@PathVariable String bloodgrp, @PathVariable int qty) {
		BloodStock bloodstock = bloodStockRepository.findById(bloodgrp)
				.orElseThrow(() -> new ResourceNotFoundException("User Not Exist with Id=" + bloodgrp));
